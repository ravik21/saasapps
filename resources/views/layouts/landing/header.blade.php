<header class="fixed top-0 inset-x-0 z-50 group/header">
    ...
    <div class="relative md:mt-2 xl:mt-4 md:mx-2 xl:mx-4 px-4 md:px-2 bg-gray-100 md:rounded-16">
        <div class="relative max-w-300 mx-auto h-16 xl:h-19 flex items-center">
            ...
            <nav class="hidden md:block flex-1 flex ml-8 lg:ml-20 text-gray-800 text-ui-14-normal lg:text-ui-15-normal group/nav">
                <ul class="flex items-center gap-5">
                    <li class="flex-shrink-0">
                        <a href="javascript:void(0)" id="services-trigger" class="flex px-2 py-3 hover:underline cursor-pointer">
                            <span>Services</span>
            ...
            <!-- Mobile Menu -->
            <div id="mobile-menu" class="fixed md:hidden hidden flex-col px-4 bg-gray-100 inset-0 mt-16 transition-opacity duration-200 z-50">
                <nav class="flex-1 overflow-y-scroll overscroll-contain scrollbar-none">
                    <ul>
                        <li>
                            <!-- Features Toggle Button -->
                            <button id="features-toggle" class="sticky top-0 w-full flex items-center justify-between py-3 text-heading-2xs font-sans-heading text-gray-700 bg-gray-100 transition z-50 cursor-pointer">
                                <span>Product</span>
                                <span id="features-chevron" class="text-gray-700 transition-transform">
        ...
        <nav id="services-dropdown" class="hidden absolute pt-24 pb-10 top-0 inset-x-0 px-4 rounded-16 bg-gray-100 shadow-300 -z-10 opacity-0 transition-opacity duration-300 pointer-events-none">
            <div class="max-w-300 mx-auto flex items-center space-x-5">
                <p class="text-heading-2xs font-sans-heading">
                    Services
                </p>
                <a href="{{ route('services') }}" class="mt-1 flex items-center text-ui-14 text-gray-700 hover:underline">
...
<script>
    ...
    function showDropdown() {
        if (window.innerWidth >= 768) { // Only on desktop (md breakpoint)
            ...
            servicesDropdown.classList.remove('hidden', 'opacity-0', 'pointer-events-none');
