<header class="fixed top-0 inset-x-0 z-50 group/header">
    ...
    <div class="relative md:mt-2 xl:mt-4 md:mx-2 xl:mx-4 px-4 md:px-2 bg-gray-100 md:rounded-16">
        ...
        <nav class="absolute hidden md:block pt-24 pb-10 top-0 inset-x-0 px-4 rounded-16 bg-gray-100 shadow-300 -z-10 opacity-0 invisible group-hover/nav:opacity-100 group-hover/nav:visible transition-opacity duration-300">
