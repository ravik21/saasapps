<section class="relative pt-20 pb-12 md:py-28 border-t border-gray-300">
    ...
    <div
        ...
        <div
            ...
            <dl
                class="hidden lg:inline-grid absolute bottom-7 left-7 grid-cols-2 md:grid-cols-4 gap-x-4 grid-rows-[1fr_auto] lg:pr-24">
        ...
        <blockquote
            ...
            <p class="mt-2 md:mt-4 text-body-md lg:text-subtitle-md">
                Monotree helped create a community across our restaurants. It&#039;s great to collaborate with
                Monotree;
                it&#039;s dynamic, and we brainstorm about features, possibilities, and the industry as a whole.
                I really
                like the mix of operational features with communication - that it becomes a social network.
            </p>
            <footer class="grid grid-cols-[1fr_auto] grid-rows-2 mt-8 items-center">
                ...
                <svg class="text-gray-800 col-start-2 row-start-1 row-span-2 w-22 lg:w-24 lg:h-12" fill="currentColor"
                    stroke-width="0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 84.354 10.296">
                    <path
        ...
        <ul
          ...
          " data-index="0">
                <blockquote
                    ...
                    <p class="mt-4 text-body-md text-gray-800">
                        We launched our app in the autumn of 2021 and I honestly cannot understand how we could
                        run our business
                        beforehand. With the app, communication has not only become easier, but it has also been
                        strengthened
                        both within individual hotels and across the company.
                    </p>
                    <footer class="mt-6">
                        <figure class="flex items-center">
                            <picture>
                                <img src="assets/imgs/quote_buhlmann.webp.html"
                                    srcset="assets/imgs/quote_buhlmann@1x.webp 1x, assets/imgs/quote_buhlmann@2x.webp 2x, assets/imgs/quote_buhlmann@3x.webp 3x"
                                    class="size-12 rounded-10 border-hairline border-gray-900/10 bg-gray-300 select-none"
                                    loading="lazy" draggable="false" alt="">
                            </picture>
          ...
          " data-index="1">
                <blockquote
                    ...
                    <footer class="mt-6">
                        <figure class="flex items-center">
                            <picture>
                                <img src="assets/imgs/quote_dyreparken.webp.html"
                                    srcset="assets/imgs/quote_dyreparken@1x.webp 1x, assets/imgs/quote_dyreparken@2x.webp 2x, assets/imgs/quote_dyreparken@3x.webp 3x"
                                    class="size-12 rounded-10 border-hairline border-gray-900/10 bg-gray-300 select-none"
                                    loading="lazy" draggable="false" alt="">
                            </picture>
                            <figcaption class="ml-3">
          ...
          " data-index="2">
                <blockquote
                    ...
                    <p class="mt-4 text-body-md text-gray-800">
                        Monotree has been a great tool for internal communication and it works flawlessly on
                        mobile. We are also
                        excited to have a platform where we can gather all handbooks and instructions in one
                        place - where the
                    ...
                    <footer class="mt-6">
                        <figure class="flex items-center">
                            <picture>
                                <img src="assets/imgs/quote_friendsandbrgrs.webp.html"
                                    srcset="assets/imgs/quote_friendsandbrgrs@1x.webp 1x, assets/imgs/quote_friendsandbrgrs@2x.webp 2x, assets/imgs/quote_friendsandbrgrs@3x.webp 3x"
                                    class="size-12 rounded-10 border-hairline border-gray-900/10 bg-gray-300 select-none"
                                    loading="lazy" draggable="false" alt="">
                            </picture>
                            <figcaption class="ml-3">
